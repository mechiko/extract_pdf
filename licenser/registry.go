...
func WriteInt32Value(root registry.Key, keyPath, valueName string, data uint32) error {
	k, err := registry.OpenKey(root, keyPath, registry.WRITE)
	if err != nil {
		return err
	}
...
func WriteInt64Value(root registry.Key, keyPath, valueName string, data uint64) error {
	k, err := registry.OpenKey(root, keyPath, registry.WRITE)
	if err != nil {
		return err
	}
